...
public class CustomAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
    ...
    public CustomAuthenticationFilter(HttpSecurity http) {
        super(request -> request.getMethod().equalsIgnoreCase("GET") && request.getRequestURI().equals("/api/login"));
        setSecurityContextRepository(securityContextRepository(http));
    }
